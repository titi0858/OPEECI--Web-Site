...
<body>
   ...
   <section class="accounts">
      ...
      <h1 class="heading">Compte admins</h1>

      <div class="box-container">

         <div class="box">
            <p>Nouvel administrateur</p>
            <a href="register_admin" class="option-btn">Inscription</a>
         </div>
         ...
         ?>
               <div class="box">
                  ...
                  <div class="flex-btn">
                     <a href="admin_accounts?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('Supprimer ce compte ?');">Supprimer</a>
                     <?php
                     if ($fetch_accounts['id'] == $admin_id) {
                        echo '<a href="update_profile" class="option-btn">Modifier</a>';
                     }
                     ?>
                  </div>
               </div>
